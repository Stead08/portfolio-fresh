                        ...
                        <form onSubmit={submit} className="space-y-3">
                            ...
                            <div className="flex justify-center">
                                {status === "sending" ? (
                                    ...
                                    <input
                                        type="submit"
                                        className="text-sm uppercase border(gray-500 1) hover:(bg-gray-200 dark:bg-gray-700) disabled:(opacity-50 cursor-not-allowed)  cursor-pointer rounded-md bg-gray-100 px-3 py-2 active:bg-gray-300 "
                                        value="send"/>)}
                            </div>
                        </form>
                    )}
